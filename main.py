...
attact_defolt = 'нанёс урон противнику равный'
special_defolt = 'применил специальное умение'
...
def defence(char_name: str, char_class: str) -> str:
    """Выполняет команду блокирования."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выполняет команду специального умения."""
    if char_class == 'warrior':
        return (f'{char_name} {special_defolt} «Выносливость {80 + 25}»')
    if char_class == 'mage':
        return (f'{char_name} {special_defolt} «Атака {5 + 40}»')
    if char_class == 'healer':
        return (f'{char_name} {special_defolt} «Защита {10 + 30}»')
    return (f'{char_name} не применил специальное умение')


def start_training(char_name, char_class):
    """Выполняет команду начала тренировки."""
    if char_class == 'warrior':
...
def choice_char_class():
    """Приветсвие игрока и запрос имени."""
    approve_choice: str = ''
    approve_choice = None
    char_class = None
    char_class: str = ''
